...
class Listing(models.Model):
    ...
    developer = models.ForeignKey(Developer, on_delete=models.DO_NOTHING, null=True)
    ...
    lease_length = MultiSelectField(choices=LEASE_LENGTH, max_choices=3, max_length=3, blank=True, default='', null=True)
    security = MultiSelectField(choices=SECURITY, max_choices=1, max_length=3, blank=True, default='', null=True)
    parking = MultiSelectField(choices=PARKING, max_choices=2, max_length=3, blank=True, default='', null=True)
    service = MultiSelectField(choices=SERVICE, max_choices=2, max_length=3, blank=True, default='', null=True)
    features = MultiSelectField(choices=FEATURES, max_choices=4, max_length=3, blank=True, default='', null=True)
    fitness_recreation = MultiSelectField(choices=FITNESS_RECREATION, max_choices=4, max_length=3, blank=True, default='', null=True)
